...
const CATEGORY_OPTIONS = ["Teaser", "Food", "Fine Dining", "Beverages", "Bakery", "Behind the Scenes", "Other"];
...
function ItemModal({ item, onSave, onClose, saving }) {
  ...
  function handleFile(f) {
    ...
    const maxBytes = isVideo ? 100 * 1024 * 1024 : 10 * 1024 * 1024; // 100MB video / 10MB image
      ...
      <div className="bg-[#0f1423] border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl my-auto">
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div>
            ...
            <input type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Culinary Artistry" className={inputCls} />
          </div>
          {/* Category + Span */}
...
// ── Main editor ───────────────────────────────────────────────────────────────
export default function FNBGalleryEditor() {
