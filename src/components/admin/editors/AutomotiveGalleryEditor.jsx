// src/components/admin/editors/AutomotiveGalleryEditor.jsx
...
const CATEGORY_OPTIONS = ["Teaser", "Exterior", "Interior", "Detail", "Motion", "Other"];
...
function ItemModal({ item, onSave, onClose, saving }) {
  ...
  const [category,  setCategory]  = useState(item?.category || "Exterior");
      ...
      <div className="bg-[#0f1423] border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl my-auto">
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div>
            ...
            <input type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Speed Form" className={inputCls} />
          </div>
          {/* Category + Span */}
...
// ── Main editor ───────────────────────────────────────────────────────────────
export default function AutomotiveGalleryEditor() {
