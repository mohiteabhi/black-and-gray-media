...
const AboutSection = () => {
    ...
    const [showFNB, setShowFNB] = useState(false); // ← state to control FNB page
    ...
    // If FNB page is active, render it full-screen
    if (showFNB) {
        return <FNBShowcase onBack={() => setShowFNB(false)} />;
    }

    // Helper: determine if a service card is the FNB service
    const isFNB = (service) =>
    ...
    // Helper: render the correct link for a service card
